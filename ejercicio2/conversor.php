...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <input type="text" name="temperatura" id="tempertura"><br>

            <label for="tipo_temp">Tipo de medición:</label>
            <input type="radio" name="tipo" id="tipo" value="celsius">Celsius
            <input type="radio" name="tipo" id="tipo" value="farenheit">Farenheit <br>
